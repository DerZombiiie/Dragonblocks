...
var apple_bush_sapling={
name:"apple_bush_sapling",
mobStability:true,
buildStability:true,
texture:"url(Mods/default/textures/apple_bush_sapling.png)",
groups:["farm"],
up:0,
brakedown:0,
growtime:15000,
growto:"applebush(x,y);",
hardness:2,
inv:{
	name:"Bush Sapling",
	mod:"default",
...
var apple_bush_tree={
name:"apple_bush_tree",
mobStability:true,
buildStability:true,
texture:"url(Mods/default/textures/apple_bush_tree.png)",
groups:[],
brakedown:0,
up:0,
hardness:7,
...
blocks.push(apple_bush_tree);
blocks.push(apple_bush_sapling);
function appletree(x,y){
	setBlock(x,y-1,apple_tree);
...
function applebush(x,y){
	setBlock(x,y-1,apple_leaves);
	setBlock(x-1,y-1,apple_leaves);
	setBlock(x+1,y-1,apple_leaves);	
	setBlock(x-1,y,apple_leaves);
	setBlock(x+1,y,apple_leaves);																		
	return apple_bush_tree
	}	
mapgen_stone = stone;
mapgen_water = water;
mapgen_dirt = dirt;
